...
1. 先读取 [[00_Project/AGENT_HANDOFF]]、[[00_Project/CURRENT_STATE]]、
   [[01_Strategy/STRATEGY_MASTER]] 和 [[01_Strategy/RULE_CATALOG]]。
...
9. 需要实现时，先按 [[00_Project/AGENT_HANDOFF]] 和最新 gate 生成范围明确的
   Codex任务；NEXT_GATE 不代表自动授权执行。
10. 输出结论时标注信息来源和不确定性。
