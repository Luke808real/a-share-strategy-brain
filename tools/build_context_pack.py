...
SECTION_SOURCES = (
    ("Agent Handoff", "00_Project/AGENT_HANDOFF.md", 7_000),
    ("Current State", "00_Project/CURRENT_STATE.md", 12_000),
    ("Project Charter", "00_Project/PROJECT_CHARTER.md", 7_000),
...
def build_context_pack_text(root: Path) -> str:
    ...
    parts.extend(
        [
            ...
            "",
            f"## {section_number + 6}. 最近已审核案例",
            "",
            "> Source: [[02_Cases/CASE_INDEX]]。",
            "",
            _recent_reviewed_cases(root),
            "",
            f"## {section_number + 7}. 最近可审计推理摘要",
            "",
            ...
            "",
            f"## {section_number + 10}. 代码仓库基线与drift",
            "",
